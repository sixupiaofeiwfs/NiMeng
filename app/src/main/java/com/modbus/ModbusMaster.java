...
import com.modbus.exception.ModbusError;
import com.modbus.exception.ModbusErrorType;
import com.modbus.serial.SerialPort;
import com.modbus.util.ByteArrayReader;
import com.modbus.util.ByteArrayWriter;
import com.modbus.util.CRC16;
import com.modbus.util.ThreadUtil;
import com.modbus.util.TimeoutUtil;
 ...
 * -----------------------------------------------------------------
 * <p>
 * 2022/5/16 : Create ModbusMaster.java (wfs);
 * <p>
 * -----------------------------------------------------------------
 */
/*
