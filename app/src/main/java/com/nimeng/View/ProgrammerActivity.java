...
public class ProgrammerActivity extends BaseAvtivity<EditProgrammeContacts.EditPresenter> implements EditProgrammeContacts.EditProgrammeUI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgrammerTableAdapter adapter = new ProgrammerTableAdapter(this, list);
