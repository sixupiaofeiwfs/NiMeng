 ...
 * Author: wfs
 * <p>
 * Create: 2022/6/17 9:42
 * <p>
 * Changes (from 2022/6/17)
 * <p>
 * -----------------------------------------------------------------
 * <p>
 * 2022/6/17 : Create FileActivity.java (wfs);
 * <p>
 * -----------------------------------------------------------------
 */
public class FileActivity extends CommonUtil {
    ...
    private void write2(String str, String fileName) {
        String filePath = Environment.getExternalStorageDirectory().toString()+ File.separator + "nimengSD";
    ...
    private void write5(String str,String fileName) {
        String filePath = Environment.getExternalStorageDirectory().toString()+ File.separator + "nimeng";
