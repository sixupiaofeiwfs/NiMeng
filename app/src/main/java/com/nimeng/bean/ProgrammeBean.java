...
public class ProgrammeBean {
    ...
    private float tem_wave;//波动值(温度)
    private float hum_wave;//波动值（湿度）
...
//    public ProgrammeBean(String id, String name, int time, float tem_wave, float hum_wave, float temperature1, float temperature2, float temperature3, float temperature4, float temperature5, float temperature6, float temperature7, float temperature8, float temperature9, float temperature10, float humidity1, float humidity2, float humidity3, float humidity4, float humidity5, float humidity6, float humidity7, float humidity8, float humidity9, float humidity10) {
//        this.id = id;
//        this.name = name;
//        this.time = time;
//        this.tem_wave = tem_wave;
//        this.hum_wave = hum_wave;
...
//    }
    ...
    public ProgrammeBean(String id, String name, int time, float tem_wave, float hum_wave, float temperature1, float temperature2, float temperature3, float humidity1, float humidity2, float humidity3) {
        this.id = id;
        this.name = name;
        this.time = time;
        this.tem_wave = tem_wave;
    ...
    public float getTem_wave() {
        return tem_wave;
    }

    public void setTem_wave(float tem_wave) {
        this.tem_wave = tem_wave;
    }

    public float getHum_wave() {
        return hum_wave;
    }

    public void setHum_wave(float hum_wave) {
        this.hum_wave = hum_wave;
    }
