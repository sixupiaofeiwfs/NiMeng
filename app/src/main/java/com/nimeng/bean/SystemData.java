...
public class SystemData {
    ...
    private String standardTem;//标准器温度
    private String standardHum;//标准器湿度


    private int temState;//该字段只有两个值0和1  该字段影响首页中spinner中的默认值设置,0代表设备刚启动,没有执行方案中的其他温度或湿度点  1代表选择的方案中已经有温度或湿度点达到稳定状态,并且已经执行到下一个温度或湿度点
    ...
    public String getStandardTem() {
        return standardTem;
    }

    public void setStandardTem(String standardTem) {
        this.standardTem = standardTem;
    }

    public String getStandardHum() {
        return standardHum;
    }

    public void setStandardHum(String standardHum) {
    ...
    public String toString() {
        return "SystemData{" +
                ...
                ", temPower='" + temPower + '\'' +
                ", humPower='" + humPower + '\'' +
                ", standardTem='" + standardTem + '\'' +
                ", standardHum='" + standardHum + '\'' +
                ", temState=" + temState +
                ", humState=" + humState +
                '}';
    }
