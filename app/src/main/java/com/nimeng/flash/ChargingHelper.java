 ...
 * Author: wfs
 * <p>
 * Create: 2022/4/18 14:58
 * <p>
 * Changes (from 2022/4/18)
 * <p>
 * -----------------------------------------------------------------
 * <p>
 * 2022/4/18 : Create ChargingHelper.java (wfs);
 * <p>
 * -----------------------------------------------------------------
 */
public class ChargingHelper {
    ...
    public static void generateBubble(List<Bubble> bubbleList, float x, float y, float radius, float speedY, int alpha, int color, float sizeRadio){
